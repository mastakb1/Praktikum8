...
{ 
    $nameErr = "Inputan Hanya boleh berupa huruf dan spasi";
}
} 
...
//TELEPON
    ...
    {
        $error_telepon = "Telepon tidak boleh kosong!";
    }
    else
    {
        ...
        {
            $error_telepon = "Hanya boleh berupa angka!";
        }
    }
        ...
        <div class = "card">
            ...
            <div class = "card-body">
                <form method="post" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    ...
                    <div class="form-group row">
                        <label for = "web" class= "col-sm-2 col-form-label">Telepon</label>
                        <div class = "col-sm-10">
                            <input type="text" name="telepon" class="form-control <?php echo ($error_telepon !="" ? "is-invalid" : ""); ?>" id = "telepon" placeholder = "telepon" value = "<?php echo $telepon; ?>"> <span class="warning"><?php echo $error_telepon; ?></span>
                        </div>
                    </div>
